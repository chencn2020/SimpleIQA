...
import torch
from SimpleIQA.AwesomeIQA.TeacherIQA import teacherNetwork as TN
...
class StudentNetwork(nn.Module):
    def __init__(self):
        ...
        pkl = torch.hub.load_state_dict_from_url("https://github.com/chencn2020/TeacherIQA/releases/download/weight/teacherNetwork.pkl")
        self.tn.load_state_dict(pkl)
